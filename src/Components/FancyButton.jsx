...
const FancyButton = ({ children, onClick, className = "" }) => {
  return (
    <button
      onClick={onClick}
      className={`hover:scale-105 transition relative inline-flex items-center justify-center px-8 py-2 overflow-hidden text-white bg-[#A87914] rounded-sm group cursor-pointer ${className}`}
    >
